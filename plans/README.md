...
5. **No git commands in this workflow.** Do not use git commands as part of
   implementing or documenting plans; treat repository state changes as managed
   outside these execution steps.
6. **If you hit bugs during rollout**, log them in
...
| 06 | [Tags and task dependencies](06_tags_and_dependencies.md)          | 2    | Done        | 2026-04-28 | 2026-04-28 | Tags CRUD + task tag filtering, dependencies with cycle guard, dependency/parent searchable picker pattern, and blocked-upstream list indicator shipped. |
